...
- 2026-05-17: imported Anthropic `The Founder's Playbook` from `refs/my-blog-kb`, added a compiled article card, and merged AI-native startup operating observations into human-supervised ops, externalized state, runtime surfaces, and LLM agent navigation.
...
- 2026-05-29: ingested Dan Shipper / Every `After Automation` from `refs/my-blog-kb/raw/inbox/`, normalized it into `raw/sources/2026/`, added a compiled article card, and merged frame/framer, benchmark framing, agent-employee vs work-OS, and human-supervised review-loop observations into agent concept and map pages.
...
- 2026-05-29: ingested Anthropic Engineering `Demystifying evals for AI agents` from `refs/my-blog-kb`, normalized it into `raw/sources/2026/`, added a compiled article card, introduced `agent-evaluations`, and merged eval harness / grader / transcript / reliability-metric observations into agent maps and harness/runtime concept pages.
- 2026-05-30: ingested Akshay Pachaar `Hermes Agent Masterclass` from `refs/my-blog-kb`, normalized it into `raw/sources/2026/`, added a compiled article card, and merged layered memory / self-evolving skills / GEPA / profile-isolation observations into agent state, runtime, harness, eval, and map pages.
