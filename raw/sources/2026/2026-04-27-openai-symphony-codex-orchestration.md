...
![An open-source spec for Codex orchestration: Symphony](https://images.ctfassets.net/kftzwdyauwt9/1lLb8Tk8Ht0kZC0UzoJysb/bac9e34838a4f94afd44b1c9adfa8780/Symphony_SEO_card__1_.png?w=1600&h=900&fit=fill)
...
To solve this new problem, we built a system called *Symphony*. [Symphony⁠(opens in a new window)](https://github.com/openai/symphony) is an agent orchestrator that turns a project-management board like Linear into a control plane for coding agents. Every open task gets an agent, agents run continuously, and humans review the results.
