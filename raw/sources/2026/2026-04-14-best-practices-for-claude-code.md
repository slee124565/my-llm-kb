...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](https://code.claude.com/cdn-cgi/l/email-protection#740107110634110c15190418115a171b19) is true, invalid is false, [[email protected]](https://code.claude.com/cdn-cgi/l/email-protection#84f1f7e1f6c4aae7ebe9) is false. run the tests after implementing”* |
...
to learn about foo tool, then use it to solve A, B, C.
